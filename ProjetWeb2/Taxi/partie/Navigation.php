...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="accueil.php">Witaxi</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="services.php">Particuliers</a>
                </li>
                <li>
                    <a href=".php">Professionnels</a>
                </li>
                 <li>
                    <a href=".php">Communication</a>
                </li>
                <li>
                    <a href=".php">Qui sommes nous ? </a>
                </li>
                <li>
